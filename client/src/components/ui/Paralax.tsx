  ...
  return (
    <section className="relative overflow-hidden bg-white px-6 py-20 md:px-10 md:py-24">
      <div className="mx-auto max-w-6xl">
        <div className="relative overflow-hidden rounded-[36px] bg-slate-900 px-6 py-10 text-white md:px-10 lg:px-14 lg:py-14">
          <div className="relative grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(360px,480px)]">
            ...
            <div className="relative mx-auto w-full max-w-[460px]">
              <div className="absolute -top-6 right-2 h-24 w-24 rounded-[28px] bg-emerald-500 md:h-28 md:w-28" />
              <div className="absolute -bottom-8 left-4 h-24 w-24 rounded-full bg-white/10 md:h-32 md:w-32" />

              <div className="relative rounded-[28px] bg-slate-800 p-4">
                ...
                <div className="absolute -top-5 left-4 rounded-2xl bg-emerald-500 px-4 py-3 text-white">
                  <p className="text-xs font-medium text-emerald-100">Clientes satisfechos</p>
                  <p className="mt-1 text-lg font-bold">+1,000</p>
                </div>

                <div className="absolute -bottom-5 right-4 rounded-2xl bg-white px-4 py-3 text-slate-900 border border-slate-100">
